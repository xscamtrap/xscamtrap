...
- Emily - @4Onasu
- tyle22juoo - @t_stoneyla_44

Use grabdm.js to copy/paste into a Chrome Web Developer console to scroll through an active conversation and copy/paste the text. Output needs cleanup but is good first step.
